...
class SearchService {
  ...
  Future<List<Product>> fetchProductService( {required BuildContext context,required String search}) async {
    final userProvider = Provider.of<UserProvider>(context, listen: false);
    List<Product> list = [];
    try {
      http.Response res =
          await http.get(Uri.parse('$uri/api/product/search/$search'), headers: {
